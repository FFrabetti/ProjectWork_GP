...
public class MulinoMatch {

	private double scoreW;
	private double scoreB;
	
	public MulinoMatch(Node w, Node b, int maxMoves, Random rand) {
...
//		System.out.println("Score " + Checker.BLACK + ": " + (nrCheckersB-nrCheckersW));
		scoreW = (nrCheckersW-nrCheckersB);
		scoreB = (nrCheckersB-nrCheckersW);
	}

	public double getScore(Checker c) {
		return c == Checker.WHITE ? scoreW : scoreB;
	}
	
	private Double evalState(MulinoState futureState, Checker dutyPlayer, Node node) {
...
//		System.out.println("value = " + ev.getResult());
	...
	private void placeCheckers(Checker c, int n, Board b, Random rand) {
