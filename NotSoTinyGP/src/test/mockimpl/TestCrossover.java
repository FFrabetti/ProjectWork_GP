...
public class TestCrossover {
	...
	public static void main(String[] args) {
		...
		Crossover xo = new SubtreeCrossover(random);		// 90% function nodes
		Crossover xof = new SubtreeCrossover(random, 1);	// function nodes as crossover points
		Crossover xot = new SubtreeCrossover(random, 0);	// terminal nodes as crossover points
